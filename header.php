...
<body <?php body_class(); ?>>
	...
	?>
	<a class="skip-link screen-reader-text" href="#content"><?php esc_html_e('Skip to content', 'superb-pixels'); ?></a>
	...
	$superb_pixels_overwrite_slider_shortcode = get_theme_mod('header_metaslider_overwrite');
	if (!empty($superb_pixels_overwrite_slider_shortcode) && shortcode_exists("metaslider") && has_shortcode($superb_pixels_overwrite_slider_shortcode, "metaslider")) {
		if (get_theme_mod('only_show_header_frontpage_metaslider') == '') {
			if (is_front_page()) {
				superb_pixels_theme_metaslider_header_output();
			}
		} else {
			superb_pixels_theme_metaslider_header_output();
		}
		...
		if (get_theme_mod('only_show_header_frontpage') == '') {
			if (is_front_page()) {
				superb_pixels_default_theme_header_output();
			}
		} else {
			superb_pixels_default_theme_header_output();
		}
	...
	<?php
	function superb_pixels_default_theme_header_output()
	{
		?>
		<!-- Header img -->
	...
	function superb_pixels_theme_metaslider_header_output()
	{
