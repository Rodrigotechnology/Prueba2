...
get_header(); ?>
<div id="content" class="site-content clearfix"> <?php $superb_pixels_container_class = !is_page_template('elementor_header_footer') ? 'content-wrap' : 'content-none'; ?> <div class="<?php echo esc_html($superb_pixels_container_class); ?>">
        <div id="primary" class="featured-content content-area <?php if (CustomizerControls::GetSelectedOrDefault(CustomizerControls::BLOGFEED_HIDE_SIDEBAR) == '1' || !is_active_sidebar('sidebar-1')) : ?>fullwidth-area-blog<?php endif; ?> add-blog-to-sidebar">
            <main id="main">
                ...
                if (have_posts()) : ?>
                    ...
                    superb_pixels_numeric_posts_nav();
                    echo '</div>';
                else :
